...
<head>
    ...
    <c:set var="registerFlag" value="${empty categoryDto.id ? 'create' : 'modify'}"/>
    <title>Category <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" /></c:if>
...
<form:form modelAttribute="categoryDto" id="detailForm" name="detailForm">
    <div id="content_pop">
    	<!-- 타이틀 -->
    	<div id="title">
    		<ul>
    		...
    		<c:if test="${registerFlag == 'modify'}">
        		<tr>
        			...
        			<td class="tbtd_content">
        				<form:input path="id" cssClass="essentiality" maxlength="20" readonly="true" />
        			</td>
        		</tr>
    		</c:if>
    		<tr>
